Feature: Photo upload
  ...
  Scenario: Upload photo with a file (base64)
    ...
    """
      {
        "file_base64": "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAB3RJTUUH3AkRDwwzVKRNWAAAAB1pVFh0Q29tbWVudAAAAAAAQ3JlYXRlZCB3aXRoIEdJTVBkLmUHAAAADUlEQVQI12NgYGBgAAAABQABXvMqOgAAAABJRU5ErkJggg==",
        "camera": "Sony",
        "title": "marmot_king",
        "author": "Robert",
        "date": "2012-08-01 12:45"
